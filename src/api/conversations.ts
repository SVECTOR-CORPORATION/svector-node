...
export class Conversations {
  ...
  /**
   * Create a sophisticated conversation with instructions and input
  ...
  async create(
    ...
    // Convert the sophisticated interface to the internal chat completion format
    ...
    // Convert back to sophisticated format
    return {
  ...
  async createStream(
    ...
    // Convert internal stream format to sophisticated format
  ...
  /**
   * Transform internal stream events to sophisticated format
   */
